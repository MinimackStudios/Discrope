...
router.post("/login", (0, express_validator_1.body)("username").trim().matches(/^[a-z0-9]{2,32}$/), (0, express_validator_1.body)("password").isLength({ min: 6, max: 128 }), validate_1.validateRequest, authController_1.login);
