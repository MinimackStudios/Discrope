...
router.get("/:dmChannelId/messages/search", dmController_1.searchDMMessages);
router.get("/:dmChannelId/messages", dmController_1.listDMMessages);
router.get("/:dmChannelId/messages/:messageId/context", dmController_1.getDMMessageContext);
